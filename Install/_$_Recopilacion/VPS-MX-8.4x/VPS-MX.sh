...
wget -O /usr/bin/SOPORTE https://raw.githubusercontent.com/lacasitamx/VPSMX/master/code/SOPORTE &>/dev/null
...
[[ -f "/usr/sbin/ufw" ]] && ufw allow 443/tcp ; ufw allow 80/tcp ; ufw allow 3128/tcp ; ufw allow 8799/tcp ; ufw allow 8080/tcp ; ufw allow 81/tcp
