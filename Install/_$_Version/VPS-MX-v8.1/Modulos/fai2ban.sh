...
wget -O $HOME/fail2ban https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.1-Casita/Install/ArchivosUtilitarios/fail2ban-0.9.4.tar.gz &> /dev/null
